...
const rgbVal ws2812_RED = {.r = 255};
const rgbVal ws2812_GRN = {.g = 255};
const rgbVal ws2812_BLU = {.b = 255};
const rgbVal ws2812_WHITE = {.r = 255, .g=255, .b = 255};
const rgbVal ws2812_OFF = {.r = 0, .g=0, .b = 0};
